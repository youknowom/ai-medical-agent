...
import { ArrowRight, ChevronRight, Zap, Sparkles, Menu, X } from "lucide-react";

// ─────────────────────────────────────────────────────────
// SARVAM-STYLE LANDING PAGE — FULLY RESPONSIVE
// ─────────────────────────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs sm:text-sm text-center">AI Medical Intelligence is live in beta. Try Now</span>
      ...
      >
        {/* Hero background gradient blobs — exactly like sarvam */}
        <div className="absolute inset-0 -z-0">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(to bottom, transparent, #F2F2EF)",
            }}
          />
        </div>
      ...
      {/* ── TRUSTED BY (logo bar) ── */}
      <section
        className="py-10 sm:py-14 border-t border-neutral-200/60"
      ...
      {/* ── SECTION HEADING ── */}
      <section className="pt-16 sm:pt-24 pb-6 sm:pb-8" style={{ background: "#EAEAE7" }}>
      ...
      {/* ── FEATURE CARDS (Sarvam style 2-column) ── */}
      <section className="pb-8 sm:pb-10 pt-8 sm:pt-10" style={{ background: "#EAEAE7" }}>
      ...
      {/* ── FINAL CTA ── */}
      <section className="py-20 sm:py-32" style={{ background: "#F2F2EF" }}>
      ...
      {/* ── FOOTER ── */}
      <footer
        className="py-8 sm:py-10 border-t border-neutral-200/60"
        style={{ background: "#F2F2EF" }}
      >
...
// ─────────────────────────────────────────────────────────
// FeatureCard — Sarvam 2-col layout
// ─────────────────────────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href={href}>
          <button className="self-start flex items-center gap-2 text-sm font-semibold text-neutral-900 hover:gap-3 transition-all duration-200">
...
// ─────────────────────────────────────────────────────────
// Graphics (colourful abstract cards like sarvam)
// ─────────────────────────────────────────────────────────
    ...
    <nav
      ...
      style={{
        background: scrolled || menuOpen
          ? "rgba(242,242,239,0.95)"
          : "rgba(242,242,239,0.70)",
          ...
          <div className="hidden md:flex items-center gap-3">
            {!user ? (
              <>
                ...
                <Link href="/dashboard">
                  <button
                    ...
                    style={{
                      background: "#111",
                      boxShadow: "inset 0 0 0 1px rgba(255,255,255,0.14), 0 2px 8px rgba(0,0,0,0.18)",
                    }}
                  >
                    Experience MediPulse
                  </button>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link href="/dashboard">
                  <button
                    className="px-5 py-2.5 rounded-full text-white text-sm font-semibold transition-all duration-150 hover:opacity-90"
                    style={{
                      background: "#111",
